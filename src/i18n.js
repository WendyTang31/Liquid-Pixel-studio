...
const EXACT = {
  ...
  '🧱实心':'🧱Solid',
  '🧱 本形状实心:停留=矢量锐边整块;过渡=溶解为点再凝回':'🧱 This shape is solid: crisp vector block on hold; dissolves to dots in transitions',
  '本形状已回到点阵':'Shape back to dots',
  ...
  '定距需要恰好选中 2 个':'Gap link needs exactly 2 selected',
  '等尺寸需要恰好选中 2 个':'Equal size link needs exactly 2 selected',
  '对称绑定:先选中 1 个原件':'Mirror link: select 1 source first',
  '先加一条中线(┃/━)':'Add a centerline first (┃/━)',
  '先选中要对中的形状':'Select shapes to center first',
  '先选中一条自由轮廓(钢笔画的)':'Select a pen path first',
